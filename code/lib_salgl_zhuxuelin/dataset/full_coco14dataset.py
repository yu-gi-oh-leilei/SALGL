...
class FullCOCO2014dataset(data.Dataset):
    ...
    def __init__(self, dataset_dir, 
        ...
        label_path = osp.join(dataset_dir, 'data', '{}_label_vectors_coco14.npy'.format(mode))
    ...
    def __getitem__(self, index):
        ...
        #     return input, self.changedLabels[index], self.full_label[index]
        # else:
