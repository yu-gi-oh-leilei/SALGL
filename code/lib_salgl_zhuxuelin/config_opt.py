...
# model
_C.MODEL.SALGL = CN()
_C.MODEL.SALGL.embed_type = 'bert'
_C.MODEL.SALGL.num_scenes = 6
_C.MODEL.SALGL.soft = False
_C.MODEL.SALGL.topk = 3
_C.MODEL.SALGL.threshold = 0.5
_C.MODEL.SALGL.outmess = True 
_C.MODEL.SALGL.num_steps = 3
_C.MODEL.SALGL.zero_init = False
_C.MODEL.SALGL.comat_ema = True
_C.MODEL.SALGL.normalize = True
_C.MODEL.SALGL.ignore_self = False
_C.MODEL.SALGL.soft = False
_C.MODEL.SALGL.pos = False
_C.MODEL.SALGL.lamda = 1.0
_C.MODEL.SALGL.pct_start = 0.2
_C.MODEL.SALGL.distributed = True
_C.MODEL.SALGL.embed_path = 'data/voc2007/bert.npy'
_C.MODEL.SALGL.comat_path = 'data/voc2007/comatrix.npy'
_C.MODEL.SALGL.ignore_path = 'data/voc2007/ignore.npy'
...
_C.LOSS.Coef.sample_en_coef = 1.0
_C.LOSS.Coef.batch_en_coef = 1.0
